        ...
        return (
            <View style={{ flex: 1, width: "100%", padding: 20, paddingBottom: 40, backgroundColor: 'white' }}>
                ...
                <View style={{ borderColor: 'black', borderWidth: 2, flex: 1, padding: 20, marginBottom: 40 }}>
                    <Text style={{ paddingBottom: 15, fontSize: 30, }} >Product:</Text>
                    <Text style={{ paddingBottom: 15, fontSize: 40, }} >Carrots</Text>
                    <Text style={{ paddingBottom: 15, fontSize: 30, }} >Weight (KGs):</Text>
                    <Text style={{ paddingBottom: 15, fontSize: 40, }} >10</Text>
                    <Text style={{ paddingBottom: 15, fontSize: 30, }} >Price (KSH):</Text>
                    <Text style={{ paddingBottom: 15, fontSize: 40, }} >399</Text>
                    <Text style={{ paddingBottom: 15, fontSize: 30, }} >Class:</Text>
